use core::utils::{get_tx_explorer_url, try_parse_required_nonzero_spectre_as_sompi_u64};
use core::{error::Error as SpectreError, tip_transition_wallet::TipTransitionWallet};
use std::sync::Arc;

use poise::serenity_prelude::{self, CreateMessage};
...
use crate::{
    ...
    utils::{create_error_embed, send_reply},
};
...
pub async fn send(
    ctx: Context<'_>,
    #[description = "Send to"] user: serenity_prelude::User,
